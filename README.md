...
I made it from scratch. I used multiple HTML pages ( About page, Index page), CSS, made application responcive and SEO friendly. Also I learned how to use library to stile web-pages and created navbar.

## Link on application
 To see and check how it works you can use this link: https://coruscating-shortbread-d67e90.netlify.app/
